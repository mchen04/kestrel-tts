...
| `student-fast-natural` preset (**re-pointed cycle 86 → `AuxMaskHead`**) | opt-in: **UTMOS 4.2162, F0 32.49, vuv 30.17, MCD 13.443, spk 0.9777, WER 5.38** — no pitch or voicing regression vs baseline. Superseded cycle-82 text: UTMOS 4.1450 / F0 33.34. Older still: **UTMOS 4.1316** (best student config; +0.155 vs `student-fast`, tied with `student-natural` at 4× the speed), WER 5.42 %, spk-cos 0.9769 — but **F0 RMSE 43.88** vs 31.82 and vuv 39.73 vs 29.38. **Cycle 79 confirmed the pitch loss is real** (independent estimator: 44.3 → 75.2 Hz, +69.6 %), not an artifact. Not the default |
