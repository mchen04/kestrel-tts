...
| `student-fast-natural` preset (cycle 78, **re-pointed cycle 82**) | opt-in, now step-2000 snapshot: **UTMOS 4.1450, F0 33.34** (was 4.1316 / 43.88). Older text: **UTMOS 4.1316** (best student config; +0.155 vs `student-fast`, tied with `student-natural` at 4× the speed), WER 5.42 %, spk-cos 0.9769 — but **F0 RMSE 43.88** vs 31.82 and vuv 39.73 vs 29.38. **Cycle 79 confirmed the pitch loss is real** (independent estimator: 44.3 → 75.2 Hz, +69.6 %), not an artifact. Not the default |
