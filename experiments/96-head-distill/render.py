...
from fastkoko.models.vocoder import FreeHead
out=Path("experiments/96-head-distill/render"); out.mkdir(parents=True,exist_ok=True)
eng=StudentKokoro(mckpt="experiments/96-head-distill/ckpt", head_cls=FreeHead)
