...
out=Path("experiments/95-vocos-head/render"); out.mkdir(parents=True,exist_ok=True)
eng=StudentKokoro(mckpt="experiments/95-vocos-head/ckpt", head_cls=FreeHead)
