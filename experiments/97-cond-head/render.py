...
from fastkoko.models.vocoder import CondHead
out=Path("experiments/97-cond-head/render"); out.mkdir(parents=True,exist_ok=True)
eng=StudentKokoro(mckpt="experiments/97-cond-head/ckpt", head_cls=CondHead)
