...
import sys as _s; _s.path.insert(0, str(Path(__file__).resolve().parent)); import sys as _s2; _s2.path.insert(0, "."); from fastkoko.models.vocoder import DeadBinResMaskHead as MaskHead
...
def main():
    ...
    net = MaskHead(dim=a.dim, blocks=a.blocks, res_scale=a.res_scale)
    net.load_weights(str(Path(a.resume) / "gen.safetensors"), strict=False)
    if a.zero_res: net.zero_residual()
