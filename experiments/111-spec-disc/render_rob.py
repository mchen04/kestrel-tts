...
out = Path("experiments/111-spec-disc/rob_8000"); out.mkdir(parents=True, exist_ok=True)
eng = StudentKokoro(mckpt="experiments/111-spec-disc/eval8000", head_cls=SFNoiseHead)
